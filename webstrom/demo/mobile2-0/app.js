 ...
 */
define(["angular-amd", "angular-ui-router","header",'overlay','overlay-controller'], function(angularAMD) {



    //创建模块app
    var app = angular.module("app", ["ui.router",'header','ui.overlay','overlay.controller']);
    ...
    app.config(["$stateProvider", "$urlRouterProvider", "$httpProvider", function($stateProvider, $urlRouterProvider, $httpProvider) {
        ...
        $stateProvider.state("about", angularAMD.route({
            url: "/about",
            templateUrl: "/kfz-angular-demo/mobile2-0/module/demo/views/about.html",
            controller: "demoAboutController"
        }));
